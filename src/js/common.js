...
function writeTime()
{
	...
	function getCookie(name){
		...
		var text_title = whichpic.getAttribute("title");
		var title = document.getElementById("title"); 
		title.firstChild.nodeValue=text_title; 
		
		var text_lead = whichpic.getAttribute("lead");
		var lead = document.getElementById("lead"); 
		lead.firstChild.nodeValue=text_lead; 
		
		var text = whichpic.getAttribute("desc");
		var desc = document.getElementById("desc"); 
		desc.firstChild.nodeValue=text;		 			
	}
	function showDetail(whichpic){		var id =whichpic.getAttribute("id");		var ln =whichpic.getAttribute("ln");		var src ='inc_detail.php?id='+id+'&lang='+ln; 		var description = document.getElementById("product_detail"); 		description.setAttribute("src",src); 	}
function resizeIF(){
	if(window.parent){
