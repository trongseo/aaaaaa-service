<%@ Page Language="C#" AutoEventWireup="true" CodeFile="trado.aspx.cs" Inherits="trado" %>
  ...
  <tr class="gradeA <%=odd%>">
		    ...
		    <%
                         ...
                         %>
                            ...
                            <asp:Button ID="Button1" runat="server" Text="Trả đồ" class="form-control" style="height:50px;width:94px;display:inline-block" OnClick="Button1_Click" />
                        </div>
                        <!-- /.panel-body -->
                    </div>
                    <!-- /.panel -->
