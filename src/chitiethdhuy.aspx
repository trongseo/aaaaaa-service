<%@ Page Language="C#" AutoEventWireup="true" CodeFile="chitiethdhuy.aspx.cs" Inherits="chitiethdhuy" %>
...
<input type="button" value="Quay về" onclick="inra(this)" style="width:50px;height:50px"/> 
<input type="button" id="btnHuy" value="Thoát" onclick="thoat(this)" style="width:50px;height:50px"/> (Khi hủy sẽ được hoàn tiền lại)
<script>
    function inra(obj)
    {
        ...
        //window.print();
        window.location = 'donhanglist.aspx';
    }
    function thoat(objx)
    {
        if (confirm("Bạn có chắc là muốn hủy đơn hàng ngày!")) {
            window.location = 'chitiethdhuy.aspx?guid_guid_huy=<%=Request["guid_id"]%>'; 
        }
