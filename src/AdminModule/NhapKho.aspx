<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NhapKho.aspx.cs" Inherits="AdminModule_NhapKho" %>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Phiếu nhập kho sản phẩm</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                     ...
                                     <div class="form-group">
                                            <label>Loại</label>
                                            <asp:DropDownList ID="DropDownList1" CssClass="form-control" runat="server" Width="178px" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                                        </asp:DropDownList>
                                        </div>

                                        <div class="form-group">
                                            <label>Tên sản phẩm</label>
                                            <asp:DropDownList ID="DropDownList2TenSP" CssClass="form-control" runat="server" Width="178px" AutoPostBack="True">
                                        </asp:DropDownList>
                                        </div>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TextBox3Price"
                                         ...
                                         <div class="form-group">
                                           ...
                                           <asp:TextBox ID="TextBox1Quantity" runat="server"  CssClass="form-control"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBox1Quantity"
                                            Display="Dynamic" CssClass="help-block" ErrorMessage="Vui lòng nhập!" ValidationGroup="xxx">Vui lòng nhập!</asp:RequiredFieldValidator>
                                        </div>
                                         <div class="form-group">
                                           <label>Ghi chú </label>
                                           <asp:TextBox ID="TextBox1Note" runat="server"  CssClass="form-control"></asp:TextBox>
