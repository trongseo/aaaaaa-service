<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NapTien.aspx.cs" Inherits="AdminModule_NapTien" %>
...
&nbsp;<asp:DropDownList ID="DropDownList1" CssClass="form-control" runat="server" >
                                        ...
                                        <div class="form-group">
                                            <label>Số tiền </label>&nbsp;<asp:TextBox ID="TextBox3Price" runat="server"  CssClass="form-control"></asp:TextBox>&nbsp;
                                        </div>
                                         <div class="form-group">
                                            <label> Ghi chú</label>
