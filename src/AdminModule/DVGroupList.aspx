<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DVGroupList.aspx.cs" Inherits="AdminModule_DVGroupList" %>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Danh sách danh mục dịch vụ</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <!-- /.panel-heading --><button type="button" onclick="javascript:window.location='DVGroupList.aspx?add=1'" class="btn btn-default">Thêm mới </button>
