...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Cập nhật nhân viên
                    </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                                ...
                                <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <asp:TextBox ID="TextBoxMatKhau" Text="123456" data-validation="required" runat="server"  CssClass="form-control"></asp:TextBox>
