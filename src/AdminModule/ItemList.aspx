<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ItemList.aspx.cs" Inherits="AdminModule_ItemList" %>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        </div>--%><div class="form-group"><asp:DropDownList id="DropDownList1" runat="server"  AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                                        </asp:DropDownList> 
                                            <button type="button" onclick="javascript:window.location='ItemUpdate.aspx?add=1'" class="btn btn-default">Thêm mới </button>
                                        </div>
                        <!-- /.panel-heading -->
