<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DichVuList.aspx.cs" Inherits="AdminModule_DichVuList" %>
                    ...
                    <div class="panel panel-default">
                        <%--<div class="panel-heading">
                             <div class="well">
                                            ...
                                            <button type="button" onclick="javascript:window.location='DichVu.aspx?add=1'" class="btn btn-default">Thêm mới </button>
                                        </div>
                        <!-- /.panel-heading -->
