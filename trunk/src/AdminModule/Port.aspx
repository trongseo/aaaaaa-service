<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Port.aspx.cs" Inherits="AdminModule_Port" %>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Danh sách port</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <!-- /.panel-heading --><button type="button" onclick="javascript:window.location='Port.aspx?add=1'" class="btn btn-default">Thêm mới </button>
                        ...
                        for (int i = 0; i < dt.Rows.Count; i++)
                        {
                            ...
                            %>
                                          ...
                                          <tr class="<%=odd%> gradeX">
                                            ...
                                            <td><input type="text" id="portnumber_<%=dr["Id"]%>" value="<%=dr["portnumber"]%>" name="portnumber_<%=dr["Id"]%>"/></td>
