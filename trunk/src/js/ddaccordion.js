...
var ddaccordion={
	...
	$(document).ready(function(){
		...
		expandedindices=(typeof expandedindices=='string')? expandedindices.replace(/c/ig, '').split(',') : 33 //test for valid cookie ('string'), otherwise (null, or 1st page load), default to defaultexpanded setting
